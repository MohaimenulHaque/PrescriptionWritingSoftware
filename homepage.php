...
if ($ROW) {
    ...
    $DOC_NAME = 'Mohaimenul Haque';
    $DOC_EMAIL = 'haquerion2000@gmail.com';
}
...
if (isset($_GET['regid'])) {
    ...
    while ($ROW = mysqli_fetch_array($RES)) {
        ...
        $OE_DATA[5] = $ROW['Lungs'];
        $OE_DATA[6] = $ROW['Abd'];
        $OE_DATA[7] = $ROW['Anaemia'];
        $OE_DATA[8] = $ROW['Jaundice'];
        $OE_DATA[9] = $ROW['Cyanosis'];
        $OE_DATA[10] = $ROW['Oedema'];
...
$query = "SELECT MAX(RegNo)FROM patientdatabase";
                ...
                <div class="OE">
                    ...
                    <table class="oeTable">
                        ...
                        <tr>
                            ...
                            <td class="value_col"><textarea  name="BP" class="value" id="" value="<?php echo ($OE_DATA[0]) ?>" cols="0" rows="1">120/80</textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="bpUnit" id="" value="mmHg"></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Pulse</td>
                            <td class="value_col"><textarea name="Pulse" class="value" id="" value="<?php echo ($OE_DATA[1]) ?>" cols="0" rows="1">75</textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="pulseUnit" id="" value="b/min"></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Temp</td>
                            <td class="value_col"><textarea name="Temp" class="value" id="" value="<?php echo ($OE_DATA[2]) ?>" cols="0" rows="1">98</textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="tempUnit" id="" value="°F"></td>
                        </tr>

                        <tr>
                            <td class="oe_col">SpO<sub>2</sub></td>
                            <td class="value_col"><textarea name="SpO2" class="value" id="" value="<?php echo ($OE_DATA[3]) ?>" cols="0" rows="1">100</textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="spO2Unit" id="" value="%"></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Heart</td>
                            <td class="value_col"><textarea name="Heart" class="value" id="" value="<?php echo ($OE_DATA[4]) ?>" cols="0" rows="1">S1+S2+M0</textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="heartUnit" id="" value=""></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Lungs</td>
                            <td class="value_col"><textarea name="Lungs" class="value" id="" value="<?php echo (@$OE_DATA[5]) ?>" cols="0" rows="1">NAD</textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="lungsUnit" id="" value=""></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Abd</td>
                            <td class="value_col"><textarea name="Abd" class="value" id="" value="<?php echo (@$OE_DATA[6]) ?>" cols="0" rows="1"></textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="abdUnit" id="" value=""></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Anaemia</td>
                            <td class="value_col"><textarea name="Anaemia" class="value" id="" value="<?php echo ($OE_DATA[7]) ?>" cols="0" rows="1"></textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="anaemiaUnit" id="" value=""></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Jaundice</td>
                            <td class="value_col"><textarea name="Jaundice" class="value" id="" value="<?php echo ($OE_DATA[8]) ?>" cols="0" rows="1"></textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="jaundiceUnit" id="" value=""></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Cyanosis</td>
                            <td class="value_col"><textarea name="Cyanosis" class="value" id="" value="<?php echo ($OE_DATA[9]) ?>" cols="0" rows="1"></textarea></td>
                            <td class="unit_col"><input type="text" class="unit" name="cyanosisUnit" id="" value=""></td>
                        </tr>

                        <tr>
                            <td class="oe_col">Oedema</td>
                            <td class="value_col"><textarea name="Oedema" class="value" id="" value="<?php echo ($OE_DATA[10]) ?>" cols="0" rows="1"></textarea></td>
                        ...
                        <tbody id="table_body">
                            ...
                            <tr class="mainBarTr">
                                ...
                                <td>
                                    ...
                                    <!-- <input type="button" value="Add" id="btn" onclick="AddRow()"> -->
                                </td>
                            ...
                            <!-- <script>
                                ...
                                function AddRow(){
                                    ...
                                    var AddRown = document.getElementById('input');
                                    var NewRow = AddRown.insertRow(n);
                                    list1[x] = document.getElementById("brand1").value;
                                    list2[x] = document.getElementById("dose1").value;
                                    list3[x] = document.getElementById("instruction1").value;
                                    list4[x] = document.getElementById("duration1").value;
                ...
                <script>
                    ...
                    function add_patient() {
                        ...
                        let p_data = '<font size="3">' + 'Name: ' + name + ' </font>' + '&nbsp;'.repeat(15) +
                            ...
                            '<font size="3">' + 'Sex: ' + (sex == 'Male' ? 'Male' : 'Female') + '&nbsp;'.repeat(15) +
                    ...
                    function add_oe() {
                        ...
                        let pulse = document.getElementsByName('Pulse')[0].value;
                        let temp = document.getElementsByName('Temp')[0].value;
                        let spo2 = document.getElementsByName('SpO2')[0].value;
                        ...
                        let anaemia = document.getElementsByName('Anaemia')[0].value;
                        let jaundice = document.getElementsByName('Jaundice')[0].value;
                        let cyanosis = document.getElementsByName('Cyanosis')[0].value;
                        let oedema = document.getElementsByName('Oedema')[0].value;

                        let bp_unit = document.getElementsByName('bpUnit')[0].value;
                        let pulse_unit = document.getElementsByName('pulseUnit')[0].value;
                        let temp_unit = document.getElementsByName('tempUnit')[0].value;
                        let spo2_unit = document.getElementsByName('spO2Unit')[0].value;
                        let heart_unit = document.getElementsByName('heartUnit')[0].value;
                        let lungs_unit = document.getElementsByName('lungsUnit')[0].value;
                        let abd_unit = document.getElementsByName('abdUnit')[0].value;
                        let anaemia_unit = document.getElementsByName('anaemiaUnit')[0].value;
                        let jaundice_unit = document.getElementsByName('jaundiceUnit')[0].value;
                        let cyanosis_unit = document.getElementsByName('cyanosisUnit')[0].value;
                        let oedema_unit = document.getElementsByName('oedemaUnit')[0].value;
                        ...
                        if (oe.length < 2) {
                            oe.push(l + '<b style=""> Pulse: </b>' + pulse + r);
                        }else {
                            oe[1] = l + '<b style=""> Pulse: </b>' + pulse + r;                            
                        }

                        if (oe.length < 3) {
                            oe.push(l + '<b style=""> Temp: </b>' + temp + r);
                        } else {
                            oe[2] = l + '<b style=""> Temp: </b>' + temp + r;
                        }

                        if (oe.length < 4) {
                            oe.push(l + '<b style=""> SpO2: </b>' + spo2 + r);
                        } else {
                            oe[3] = l + '<b style=""> SpO2: </b>' + spo2 + r;
                        }

                        if (oe.length < 5) {
                            oe.push(l + '<b style=""> Heart: </b>' + heart + r);
                        } else {
                            oe[4] = l + '<b style=""> Heart: </b>' + heart + r;
                        }

                        if (oe.length < 6) {
                            oe.push(l + '<b style=""> Lungs: </b>' + lungs + r);
                        } else {
                            oe[5] = l + '<b style=""> Lungs: </b>' + lungs + r;
                        }

                        if (oe.length < 7) {
                            oe.push(l + '<b style=""> Abd: </b>' + abd + r);
                        } else {
                            oe[6] = l + '<b style=""> Abd: </b>' + abd + r;
                        }

                        if (oe.length < 8) {
                            oe.push(l + '<b style=""> Anaemia: </b>' + anaemia + r);
                        } else {
                            oe[7] = l + '<b style=""> Anaemia: </b>' + anaemia + r;
                        }

                        if (oe.length < 9) {
                            oe.push(l + '<b style=""> Jaundice: </b>' + jaundice + r);
                        } else {
                            oe[8] = l + '<b style=""> Jaundice: </b>' + jaundice + r;
                        }

                        if (oe.length < 10) {
                            oe.push(l + '<b style=""> Cyanosis: </b>' + cyanosis + r);
                        } else {
                            oe[9] = l + '<b style=""> Cyanosis: </b>' + cyanosis + r;
                        }

                        if (oe.length < 11) {
                            oe.push(l + '<b style=""> Oedema: </b>' + oedema + r);
                        } else {
                            oe[10] = l + '<b style=""> Oedema: </b>' + oedema + r;
                        }
